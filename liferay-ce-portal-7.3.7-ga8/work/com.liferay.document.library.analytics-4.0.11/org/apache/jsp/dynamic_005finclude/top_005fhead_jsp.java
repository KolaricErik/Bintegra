    ...
    try {
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("\t\tif (event.target.nodeName.toLowerCase() === 'a' && window.Analytics) {\n");
          out.write("\t\t\tvar anchor = event.target;\n");
          ...
          out.write("\t\t\t\tvar getParameterValue = function (parameterName) {\n");
          ...
          out.write("\t\t\t\t\tfileEntryId: fileEntryId,\n");
          out.write("\t\t\t\t\tpreview: !!window.");
          out.print( DocumentLibraryAnalyticsConstants.JS_PREFIX );
          out.write("isViewFileEntry,\n");
          out.write("\t\t\t\t\ttitle: decodeURIComponent(match[3].replace(/\\+/gi, ' ')),\n");
          ...
          out.write("\t}\n");
          out.write("\n");
          out.write("\tLiferay.once('destroyPortlet', function () {\n");
          out.write("\t\tdocument.body.removeEventListener('click', handleDownloadClick);\n");
          out.write("\t});\n");
          out.write("\n");
          out.write("\tLiferay.once('portletReady', function () {\n");
