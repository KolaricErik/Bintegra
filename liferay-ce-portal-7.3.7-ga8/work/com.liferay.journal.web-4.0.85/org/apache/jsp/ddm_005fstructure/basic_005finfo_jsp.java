package org.apache.jsp.ddm_005fstructure;
...
if (
 !journalEditDDMStructuresDisplayContext.autogenerateDDMStructureKey() ) {
      ...
      _jspx_th_aui_input_3.setName("parentDDMStructureId");
      _jspx_th_aui_input_3.setType("hidden");
      _jspx_th_aui_input_3.setValue( journalEditDDMStructuresDisplayContext.getParentDDMStructureId() );
      ...
      _jspx_th_aui_input_4.setLabel("parent-structure");
      _jspx_th_aui_input_4.setName("parentDDMStructureName");
      _jspx_th_aui_input_4.setType("text");
      _jspx_th_aui_input_4.setValue( journalEditDDMStructuresDisplayContext.getParentDDMStructureName() );
      _jspx_th_aui_input_4.setWrapperCssClass("mb-2");
      ...
      _jspx_th_aui_button_0.setCssClass("mr-3");
      _jspx_th_aui_button_0.setOnClick( liferayPortletResponse.getNamespace() + "openParentDDMStructureSelector();" );
      ...
      _jspx_th_aui_button_1.setOnClick( liferayPortletResponse.getNamespace() + "removeParentDDMStructure();" );
...
if (
 ddmStructure != null ) {
      ...
      _jspx_th_aui_input_5.setName("url");
      _jspx_th_aui_input_5.setType("resource");
      _jspx_th_aui_input_5.setValue( getDDMStructureURL );
	...
	Portlet portlet = PortletLocalServiceUtil.getPortletById(portletDisplay.getId());
      ...
      _jspx_th_aui_input_6.setName("webDavURL");
      _jspx_th_aui_input_6.setType("resource");
      _jspx_th_aui_input_6.setValue( ddmStructure.getWebDavURL(themeDisplay, WebDAVUtil.getStorageToken(portlet)) );
