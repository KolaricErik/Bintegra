...
JournalDDMStructuresManagementToolbarDisplayContext journalDDMStructuresManagementToolbarDisplayContext = new JournalDDMStructuresManagementToolbarDisplayContext(request, liferayPortletRequest, liferayPortletResponse, journalDDMStructuresDisplayContext);
      ...
      _jspx_th_clay_management$1toolbar_0.setDisplayContext( journalDDMStructuresManagementToolbarDisplayContext );
      ...
      _jspx_th_portlet_actionURL_1.setName("/journal/delete_data_definition");
      _jspx_th_portlet_actionURL_1.setVar("deleteDataDefinitionURL");
      ...
      if (_jspx_eval_portlet_actionURL_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        out.write('\n');
        out.write('	');
        if (_jspx_meth_portlet_param_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_portlet_actionURL_1, _jspx_page_context))
          return;
        out.write('\n');
      }
      ...
      _jspx_th_aui_form_0.setAction( journalDisplayContext.useDataEngineEditor() ? deleteDataDefinitionURL : deleteDDMStructureURL );
...
if (
 !journalDisplayContext.isNavigationMine() && !journalDisplayContext.isNavigationRecent() ) {
      ...
      _jspx_th_liferay$1frontend_component_0.setComponentId( journalDDMStructuresManagementToolbarDisplayContext.getDefaultEventHandler() );
      _jspx_th_liferay$1frontend_component_0.setModule("js/DDMStructuresManagementToolbarDefaultEventHandler.es");
  ...
  private boolean _jspx_meth_portlet_param_0(javax.servlet.jsp.tagext.JspTag _jspx_th_portlet_actionURL_1, PageContext _jspx_page_context)
          throws Throwable {
