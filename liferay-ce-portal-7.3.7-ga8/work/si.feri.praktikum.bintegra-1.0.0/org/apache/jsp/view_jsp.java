...
String mainRequire = (String)renderRequest.getAttribute("mainRequire");
      ...
      if (_jspx_meth_portlet_namespace_0(_jspx_page_context))
        return;
      out.write("-1\">\r\n");
      out.write("\t<p>A friendly reversible message from Vue.js:</p>\r\n");
      out.write("\t<p>{{message}}</p>\r\n");
      out.write("\t<button v-on:click=\"reverseMessage\">Reverse message, pretty please</button>\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("<hr />\r\n");
      out.write("\r\n");
      ...
      if (_jspx_meth_portlet_namespace_1(_jspx_page_context))
        return;
      out.write("-3\">\r\n");
      out.write("\t<p>Button to call api</p>\r\n");
      out.write("\t<p>{{result}}</p> <br>\r\n");
      out.write("\r\n");
      out.write("\t<button v-on:click=\"fetchAPIData\">Fetch api data</button>\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("<div id=\"");
      if (_jspx_meth_portlet_namespace_2(_jspx_page_context))
        return;
      out.write("-4\">\r\n");
      out.write("\t<p>Button to create user</p>\r\n");
      out.write("\t<p>{{result}}</p> <br>\r\n");
      out.write("\t<button v-on:click=\"createUser\">Create user</button>\r\n");
      out.write("</div>\r\n");
      out.write("-->\r\n");
      out.write("<div style=\"margin: 2em;\">\r\n");
      out.write("\t<div style=\"float: right;\" id=\"");
      if (_jspx_meth_portlet_namespace_3(_jspx_page_context))
        return;
      out.write("-5\">\r\n");
      out.write("\t\t<p>Prijavljeni kot: {{loginUser}}</p>\r\n");
      out.write("\t\t<h2>Prijava:</h2>\r\n");
      out.write("\t\t<input id=\"login1\" v-model=\"loginUsername\" placeholder=\"Mail\"/> <br>\r\n");
      out.write("\t\t<input type=\"password\" id=\"login2\" v-model=\"loginPassword\" placeholder=\"Geslo\"/>\r\n");
      out.write("\t\t<button v-on:click=\"login\">Login</button>\r\n");
      out.write("\t</div>\r\n");
      out.write("\r\n");
      out.write("\t<div style=\"float: right;\" id=\"");
      ...
      out.write("\t\t<input id=\"register1\" v-model=\"registerScreenName\" placeholder=\"UporabniÅ¡ko_ime\"/> <br>\r\n");
      out.write("\t\t<input id=\"register2\" v-model=\"registerUsername\" placeholder=\"Mail\"/> <br>\r\n");
      out.write("\t\t<input type=\"password\" id=\"register3\" v-model=\"registerPassword\" placeholder=\"Geslo\"/> <br>\r\n");
      out.write("\t\t<input id=\"register4\" v-model=\"firstName\" placeholder=\"Ime \"/> <br>\r\n");
      out.write("\t\t<input id=\"register5\" v-model=\"lastName\" placeholder=\"Priimek \"/>\r\n");
      out.write("\t\t<button v-on:click=\"register\">Register</button>\r\n");
      out.write("\t</div>\r\n");
      out.write("\r\n");
      out.write("\t<div id=\"");
      if (_jspx_meth_portlet_namespace_5(_jspx_page_context))
        return;
      out.write("-7\">\r\n");
      out.write("\t\t<h2>Ustvari organizacijo:</h2>\r\n");
      out.write("\t\t<input id=\"org1\" v-model=\"organizationName\" placeholder=\"Ime organizacije\"/>\r\n");
      out.write("\t\t<input id=\"org2\" v-model=\"organizationId\" placeholder=\" Organizacija ID\"/>\r\n");
      out.write("\t\t<button v-on:click=\"createOrganization\">Create</button>\r\n");
      out.write("\t</div>\r\n");
      out.write("\r\n");
      out.write("\t<div id=\"");
      if (_jspx_meth_portlet_namespace_6(_jspx_page_context))
        return;
      out.write("-8\">\r\n");
      out.write("\t\t<h2>Organizacije</h2>\r\n");
      out.write("\r\n");
      out.write("\t\t\t<organizacije\r\n");
      out.write("\t\t\t\t\tv-bind:key=\"item.id\"\r\n");
      out.write("\t\t\t\t\tv-bind:org=\"item\"\r\n");
      out.write("\t\t\t\t\tv-for=\"item in post\"\r\n");
      out.write("\t\t\t/>\r\n");
      out.write("\r\n");
      out.write("\t</div>\r\n");
      out.write("</div>\r\n");
      ...
      _jspx_th_aui_script_0.setRequire( mainRequire );
