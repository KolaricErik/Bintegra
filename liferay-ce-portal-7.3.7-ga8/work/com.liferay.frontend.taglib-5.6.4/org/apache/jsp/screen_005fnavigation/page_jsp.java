...
if (
 screenNavigationEntries.size() > 1 ) {
        ...
        out.write("\n");
        out.write("\t\t\t\t\t\t\t");
        if (_jspx_meth_aui_icon_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_clay_row_0, _jspx_page_context))
          return;
        out.write("\n");
        out.write("\t\t\t\t\t\t</a>\n");
        out.write("\n");
  ...
  private boolean _jspx_meth_aui_icon_0(javax.servlet.jsp.tagext.JspTag _jspx_th_clay_row_0, PageContext _jspx_page_context)
          throws Throwable {
    ...
    _jspx_th_aui_icon_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_clay_row_0);
