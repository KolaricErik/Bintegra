...
if (
 !name.equals(RoleConstants.OWNER) && RolePermissionUtil.contains(permissionChecker, role.getRoleId(), ActionKeys.PERMISSIONS) ) {
		...
		if (role.getType() != RoleConstants.TYPE_REGULAR) {
          ...
          out.write("\t");
if (
 currentRoleTypeContributor.isAllowDelete(role) && RolePermissionUtil.contains(permissionChecker, role.getRoleId(), ActionKeys.DELETE) ) {
          out.write("\n");
          out.write("\t\t");
          //  portlet:actionURL
  ...
  private boolean _jspx_meth_portlet_param_4(javax.servlet.jsp.tagext.JspTag _jspx_th_portlet_actionURL_0, PageContext _jspx_page_context)
    ...
    _jspx_th_portlet_param_4.setValue("/view.jsp");
