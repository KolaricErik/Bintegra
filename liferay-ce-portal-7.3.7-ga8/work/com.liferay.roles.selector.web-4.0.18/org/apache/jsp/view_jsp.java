...
String methodName = null;
      ...
      _jspx_th_liferay$1util_buffer_0.setVar("resultsHTML");
...
if (
 className.equals(User.class.getName()) ) {
          ...
          _jspx_th_liferay$1util_include_1.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1util_buffer_0);
      ...
      if (_jspx_resourceInjector != null) _jspx_resourceInjector.preDestroy(_jspx_th_liferay$1util_buffer_0);
      _jspx_th_liferay$1util_buffer_0.release();
      java.lang.String resultsHTML = null;
      resultsHTML = (java.lang.String) _jspx_page_context.findAttribute("resultsHTML");
      out.write('\n');
      out.write('\n');
...
SearchContainer<?> searchContainer = (SearchContainer<?>)request.getAttribute("liferay-ui:search:searchContainer");
      ...
      _jspx_th_clay_management$1toolbar_0.setClearResultsURL( clearResultsURL.toString() );
      _jspx_th_clay_management$1toolbar_0.setItemsTotal( searchContainer.getTotal() );
      _jspx_th_clay_management$1toolbar_0.setNamespace( liferayPortletResponse.getNamespace() );
      ...
      if (_jspx_eval_aui_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        out.write("\n");
        out.write("\n");
        out.write("\t<div class=\"roles-selector-body\">\n");
        out.write("\t\t");
...
if (
 methodName != null ) {
      ...
      out.write("fm;\n");
      out.write("\n");
      out.write("\t\tUtil.postForm(form, {\n");
      out.write("\t\t\tdata: {\n");
      out.write("\t\t\t\tredirect: redirect,\n");
      out.write("\t\t\t\taddUserGroupIds: Util.listCheckedExcept(\n");
      out.write("\t\t\t\t\tform,\n");
      out.write("\t\t\t\t\t'");
      ...
      out.write("allRowIds'\n");
      out.write("\t\t\t\t),\n");
      out.write("\t\t\t\tremoveUserGroupIds: Util.listUncheckedExcept(\n");
      out.write("\t\t\t\t\tform,\n");
      out.write("\t\t\t\t\t'");
      ...
      out.write("\t\t\t},\n");
      out.write("\t\t\turl: '");
      if (_jspx_meth_portlet_actionURL_0(_jspx_page_context))
        return;
      out.write("',\n");
      out.write("\t\t});\n");
      out.write("\t}\n");
      ...
      out.write("\t\t\tdata: {\n");
      out.write("\t\t\t\tredirect: redirect,\n");
      out.write("\t\t\t\taddUserIds: Util.listCheckedExcept(\n");
      out.write("\t\t\t\t\tform,\n");
      out.write("\t\t\t\t\t'");
      ...
      out.write("allRowIds'\n");
      out.write("\t\t\t\t),\n");
      out.write("\t\t\t\tremoveUserIds: Util.listUncheckedExcept(\n");
      out.write("\t\t\t\t\tform,\n");
      out.write("\t\t\t\t\t'");
      ...
      out.write("\t\t\t},\n");
      out.write("\t\t\turl: '");
      if (_jspx_meth_portlet_actionURL_1(_jspx_page_context))
        return;
      out.write("',\n");
      out.write("\t\t});\n");
      out.write("\t}\n");
  ...
  private boolean _jspx_meth_portlet_actionURL_0(PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  portlet:actionURL
  ...
  private boolean _jspx_meth_portlet_actionURL_1(PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  portlet:actionURL
